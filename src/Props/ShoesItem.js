    ...
    return (
      <div>
            <div className="card text-dark bg-white">
                <img className="card-img-top" src={itemShoes.image} alt={itemShoes.name} style={{height:'250px', cursor:'pointer'}}  data-bs-toggle="modal" data-bs-target="#modalDetailShoes" onClick={()=>{
                  this.props.xemChiTiet(itemShoes)
                }}/>
                <div className="card-body small">
                    <h4 className="card-title" style={{height:'50px', cursor:'pointer'}} data-bs-toggle="modal" data-bs-target="#modalDetailShoes" onClick={()=>{
                      this.props.xemChiTiet(itemShoes)
                    }}> {itemShoes.name} </h4>
