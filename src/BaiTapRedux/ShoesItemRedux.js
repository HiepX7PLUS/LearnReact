    ...
    return (
      <div>
            <div className="card text-dark bg-white mb-4">
                <img className="card-img-top" src={product.image} alt={product.name} style={{height:250, cursor:'pointer'}}  data-bs-toggle="modal" data-bs-target="#modalShoesDetailId"/>
...
const mapDispatchToProps = (dispatch) => {
    return {
        // Gửi đi một Hàm (Hàm này chính là hàm được gắn trong onClick)
        addToCart : (sanpham)=>{
